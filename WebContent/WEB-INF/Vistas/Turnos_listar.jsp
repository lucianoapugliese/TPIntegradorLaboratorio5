...
<div class="container">
    <div class="header-row">
        ...
        <a href="altaTurno.html" class="button">
                   ...
                   <!--  <td>${turno.paciente}</td> -->
                    <td>
                        <div class="action-buttons">
                            <% if("ADMINISTRADOR".equals(session.getAttribute("rolUsuario"))){
                            	%>
                            <a href="editarturno.html?id=${turno.id}" class="edit-button" title="Editar">
                                <i class="fas fa-edit"></i>
                            </a>
                            <%} else {%>
                            <a href="verturno.html?id=${turno.id}" class="edit-button" title="Ver">
                                <i class="fas fa-eye"></i>
                            </a>
                                <%} %>
                            <% if("ADMINISTRADOR".equals(session.getAttribute("rolUsuario"))){
                            	%>
                             <a href="bajaTurno.html?id=${turno.id}" class="delete-button" title="Borrar">
...
$(document).ready(function() {
    $('#turnosTable').DataTable({
        ...
        language: {
            "decimal": "",
            "emptyTable": "No hay turnos registrados",
