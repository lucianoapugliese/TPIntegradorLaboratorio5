                ...
                <tr>
					...
					<td>
                        <div class="action-buttons">
                            <a href="editarPaciente.html?dni=${paciente.dni}" class="edit-button" title="Editar">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="bajaPaciente.html?dni=${paciente.dni}" class="delete-button" title="Dar de baja">
